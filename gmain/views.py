    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.headers.get('HX-Request'):
            if context.get('show_search'):
                ...
                return TemplateResponse(request, 'gmain/search_button.html', {})
            template = 'gmain/filter_modal.html' if request.GET.get('show_filters') == 'true' else 'gmain/catalog.html'
...
class ProductView(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        context = self.get_context_data(**kwargs)
        if request.headers.get('HX-Request'):
            return TemplateResponse(request, 'gmain/product_detail.html', context)
